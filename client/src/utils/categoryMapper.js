...
const CATEGORY_KEYWORDS = {
  ...
  'Yemek': [
    ...
    'dunkin', 'costa coffee', 'nero', 'simit sarayi', 'simit sarayi',
    'pret', 'nando', 'cay', 'kahve', 'kahveci', 'kafe', 'cafe',
    'restoran', 'restaurant', 'bistro', 'kebap', 'kebab', 'doner', 'doner',
    'pide', 'lahmacun', 'borek', 'borek', 'kokorec', 'kokorec',
    'balik', 'balik', 'deniz urunleri', 'et lokantasi', 'et lokantasi',
    'fast food', 'tavuk', 'izgara', 'mangal', 'ocakbasi', 'ocakbasi'
  ],

  'Ulaşım': [
    'iett', 'metro istanbul', 'marmaray', 'izban', 'uskudar', 'kadikoy',
    ...
    'otobus', 'otobus', 'pamukkale', 'metro turizm', 'kamil koc',
    'kimilink', 'otopark', 'park ucret', 'belpark', 'ispark',
    'dolmus', 'dolmus', 'vapur', 'feribot', 'ferry', 'ido',
    'renault', 'fiat', 'arac kiralama', 'rent a car', 'rentacar', 'avis', 'europcar',
    'interrail', 'tren', 'tcdd', 'yht', 'biletix', 'peron'
  ],

  'Akaryakıt': [
    'shell', 'bp', 'opet', 'petrol ofisi', 'total', 'aytemiz', 'moil',
    'lukoil', 'alpet', 'eko', 'go', 'akaryakit', 'akaryakit',
  ...
  'Eğlence': [
    ...
    'lunapark', 'eglence merkezi', 'eglence', 'bowling', 'laser',
    'kacis odasi', 'kacis odasi', 'escape room', 'oyun salonu',
    'konser', 'tiyatro', 'muze', 'muze', 'festival'
  ],

  'Sağlık': [
    'eczane', 'pharmacy', 'apotek', 'medikal', 'medical',
    'hastane', 'hastanesi', 'klinik', 'clinic', 'poliklinik',
    'doktor', 'doctor', 'dis', 'dis hekimi', 'dental', 'dent',
    'laboratuvar', 'lab', 'mri', 'tomografi', 'ultrason',
    'optisyen', 'optik', 'gozluk', 'gozluk', 'lens',
    'berber', 'kuafor', 'kuafor', 'coiffure', 'guzellik', 'guzellik',
  ...
  'Giyim': [
    ...
    'modanisa', 'trendyol moda', 'flo', 'polaris', 'ayakkabi', 'ayakkabi',
    'canta', 'canta', 'kemer', 'kravat', 'gomlek', 'gomlek', 'pantolon'
  ],

  'Sigorta': [
    'allianz', 'axa', 'generali', 'zurich', 'mapfre', 'sigorta',
    'eureko', 'groupama', 'ergo', 'hdi', 'turkiye sigorta',
    'gunes sigorta', 'gunes sigorta', 'magdeburger', 'aksigorta',
    'saglik sigortasi', 'kasko', 'trafik sigortasi', 'dask'
  ],

  'Fatura': [
    'turk telekom', 'turk telekom', 'vodafone', 'turkcell', 'turknet',
    'superonline', 'kablonet', 'bagnet', 'bagnet', 'ttnet',
    'elektrik', 'dogalgaz', 'dogalgaz', 'ayedas', 'ayedas',
    'tedas', 'tedas', 'baskentgaz', 'baskentgaz', 'igdas', 'igdas',
  ...
  'Abonelik': [
    ...
    'abonelik', 'subscription', 'premium', 'plus uyelik'
  ],

  'Eğitim': [
    'udemy', 'coursera', 'edx', 'skillshare', 'pluralsight',
    'ders', 'kurs', 'kurslar', 'okul', 'universite', 'universite',
    'kolej', 'dershane', 'etut', 'etut', 'kitap', 'kitabevi',
    'd&r', 'pan', 'idefix', 'bilge adam', 'btek', 'yazilim kursu',
    'sertifika', 'egitim', 'egitim'
  ],
  ...
  'Seyahat': [
    ...
    'konsoloslu', 'consulate', 'yurt disi', 'yurt disi'
  ]
};
 ...
 *
 * @returns {Object.<string, number>} Map of category to keyword count
 */
