 ...
 * @property {number} currentDebt - dönem borcu (current period debt) in TRY
 ...
 * @property {number} totalAmount - dönem borcu (total period debt) in TRY
...
export const BANK_REGISTRY = [
  ...
  { bankId: 'isbank', bankName: 'İş Bankası' },
  { bankId: 'yapikredi', bankName: 'Yapı Kredi' },
  { bankId: 'akbank', bankName: 'Akbank' },
  { bankId: 'halkbank', bankName: 'Halkbank' },
  { bankId: 'vakifbank', bankName: 'Vakıfbank' },
  { bankId: 'ziraat', bankName: 'Ziraat Bankası' },
  { bankId: 'denizbank', bankName: 'Denizbank' },
  { bankId: 'finansbank', bankName: 'QNB Finansbank' },
  { bankId: 'teb', bankName: 'TEB' },
  { bankId: 'sekerbank', bankName: 'Şekerbank' },
