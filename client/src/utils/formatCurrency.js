 ...
 * @returns {string} Formatted string e.g. "₺18.240,50"
 *
 * @example
 * formatTRY(18240.5);   // "₺18.240,50"
 * formatTRY(1000);      // "₺1.000,00"
 * formatTRY(0);         // "₺0,00"
 * formatTRY(null);      // "₺0,00"
 */
 ...
 *
 * @param {number|null|undefined} amount - The amount to format
 * @returns {string} Compact formatted string e.g. "₺18.2B" or "₺1.2M"
 *
 * @example
 * formatTRYCompact(18240);      // "₺18.2B"
 * formatTRYCompact(1250000);    // "₺1.25M"
 * formatTRYCompact(950);        // "₺950"
 * formatTRYCompact(null);       // "₺0"
 */
 ...
 * @returns {string} Signed formatted string e.g. "+₺1.240,00" or "-₺800,00"
 *
 * @example
 * formatTRYDiff(1240);    // "+₺1.240,00"
 * formatTRYDiff(-800);    // "-₺800,00"
 * formatTRYDiff(0);       // "₺0,00"
 * formatTRYDiff(null);    // "₺0,00"
 */
 ...
 * Handles strings with ₺ prefix, dots as thousand separators, and commas as decimals.
 *
